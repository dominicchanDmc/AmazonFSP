...
ActiveRecord::Schema[7.0].define(version: 2023_08_22_164012) do
  ...
  create_table "ratings", force: :cascade do |t|
    ...
    t.index ["reviewer_id", "product_id"], name: "index_ratings_on_reviewer_id_and_product_id", unique: true
